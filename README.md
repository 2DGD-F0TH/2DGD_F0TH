...
My stance on AI has evolved as time passed. You are encouraged to check the newer [AI Policy](AI_POLICY.md).

This is a mandatory step if you want to contribute.
