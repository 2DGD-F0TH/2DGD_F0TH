...
<!-- TODO: Memo on decimal numbers -->

#### Binary

{{placeholder}}

<!-- TODO: Intro to binary -->

#### Octal

{{placeholder}}
<!-- TODO: Intro to octal (less used but useful) -->

#### Hexadecimal

{{placeholder}}

<!-- TODO: Intro to hexadecimal -->
...
<!-- TODO: Talk about how not seeding RNG well can bring to foreseeable random numbers, RNG manipulation and how to seed the RNG well. Usually using the system timestamp, but also the game runtime, or mission runtime to have a more "controlled RNG" -->
