...
![Map we will create a navigation mesh on](./images/AI/nav_mesh1.png){width=60%}

The first step is to divide the map into convex polygons, in our case we will use rectangles.

![Dividing the map into many convex polygons](./images/AI/nav_mesh2.png){width=60%}
...
![Creating the graph](./images/AI/nav_mesh3.png){width=60%}
