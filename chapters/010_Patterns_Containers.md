...
<!--TODO: Add singleton pattern: allows for only one instance, talk about lazy loading and how it creates a global state on the application (so how it can be an antipattern) -->
...
**Disadvantages**     Can be a bit hard to set up, makes the architecture more complex.
------------------------------------------------------------------------------------------------
