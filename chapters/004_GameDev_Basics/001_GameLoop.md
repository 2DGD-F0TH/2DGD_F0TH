...
```{src='gameloop/semifixed_timesteps' caption='Game loop with Semi-Fixed time steps'}
```
...
![Another type of glitch created by not clearing the screen](./images/gameloop/glitchy_noclear_2.png){width=50%}
