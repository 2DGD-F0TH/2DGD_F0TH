...
- **Rust Edition:** Rust is the most admired language since it was release. Rust has gained a lot of traction as an alternative to C++ thanks for its performance and focus on memory safety.
