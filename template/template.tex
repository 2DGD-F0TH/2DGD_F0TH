...
\newenvironment{note}{
  \begin{tcolorbox}[colback=brown!5!white,colframe=brown!55!black,title=Note!]
    \begin{minipage}{.15\textwidth}
      \centering
...
\newenvironment{trivia}{
  \begin{tcolorbox}[colback=green!5!white,colframe=green!45!black,title=Random Trivia!]
    \begin{minipage}{.15\textwidth}
      \centering
