...
\newenvironment{tip}{
  \begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!white,title=Tip!,fonttitle=\bfseries]
...
\newenvironment{note}{
  \begin{tcolorbox}[colback=brown!5!white,colframe=brown!55!black,title=Note!,fonttitle=\bfseries]
    \begin{minipage}{.15\textwidth}
      \centering
...
\newenvironment{pitfall}{
  \begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Pitfall Warning!,fonttitle=\bfseries]
    \begin{minipage}{.15\textwidth}
      \centering
...
\newenvironment{trivia}{
  \begin{tcolorbox}[colback=green!5!white,colframe=green!45!black,title=Random Trivia!,fonttitle=\bfseries]
    \begin{minipage}{.15\textwidth}
      \centering
...
\newenvironment{wizardry}{
  \begin{tcolorbox}[colback=black!5!white,colframe=black!75!white,title=Advanced Wizardry!,fonttitle=\bfseries]
    \begin{minipage}{.15\textwidth}
      \centering
...
\newenvironment{longdesc}{
  \begin{tcolorbox}[colback=white,colframe=black,title=Long Description,fonttitle=\bfseries]
}{
  \end{tcolorbox}
}
\newenvironment{cover}{
...
\input{template/additional_languages/rust}
% -----------------------------------------------
...
\DeclareCaptionFormat{listing}{\fcolorbox[cmyk]{0, 0, 0, 1}{0.23, 0.15, 0.15,0.01}{\parbox{\textwidth}{\hspace{15pt}#1#2#3}}}
...
\clearpage
\null
Copyright © 2019-2026 Daniele Penazzo\\
...
\textbf{NO AI TRAINING:} any use of this publication to train generative artificial intelligence (AI) technologies to generate text is expressly prohibited.

\vspace{24pt}

\textbf{Please avoid printing this book:} this work is being periodically updated and changed as new things get added and remade, thus printing it does not make sense. Printing this book would be a waste of resources, so please think well before printing.
