...
\newenvironment{trivia}{
  \begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Trivia Time!]
    \begin{minipage}{.15\textwidth}
      \centering
...
\SetBgContents{
  \includegraphics[width=\paperwidth, height=\paperheight]{images/back_cover.pdf}
}
\pagestyle{empty}
\begin{titlepage}
  \BgThispage
