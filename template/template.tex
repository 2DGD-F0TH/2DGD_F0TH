...
$if(proglang)$
\newcommand{\code}[2]{\IfFileExists{./listings/$proglang$/#1.txt}{\lstinputlisting[language=$proglang$,caption={#2}]{./listings/$proglang$/#1.txt}}{\texttt{[MISSING CODE LISTING]}}}
$else$
\newcommand{\code}[2]{\IfFileExists{./listings/pseudocode/#1.txt}{\lstinputlisting[caption={#2}]{./listings/pseudocode/#1.txt}}{\texttt{[MISSING CODE LISTING]}}}
$endif$
% ----------------------------------------
