...
\begin{titlepage}
    \BgThispage
    $if(proglang)$
    \begin{textblock*}{5cm}(14.5cm,16.5cm) % {block width} {coords}
        \begin{center}
...
\begin{center}
    2D Game Development: From Zero To Hero ($if(proglang)$$proglang$ edition, $endif$version $version$) is licensed under the CC-BY-NC 4.0 license
\end{center}
\end{minipage}
\clearpage
