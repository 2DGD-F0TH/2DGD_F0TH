class Particle:
    ...
    def __init__(self, texture: Texture, position: Vector2, velocity: Vector2, acceleration: Vector2, lifespan: float = 2000, rotation: float = 0, a_vel: float = 0, a_accel: float = 0, mass: float = 1):
