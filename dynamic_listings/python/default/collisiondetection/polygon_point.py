# ...
def polygon_point_collision(poly: Polygon, point: Point) -> bool:
    # First of all, we get the polygon's bounding box
    bounding_box: Rectangle = poly.calculate_bounding_box();
    ...
    triangles: list[Triangle] = poly.do_fanning();
    # Now we check, for each triangle, if the point collides
    for triangle in triangles:
        if point_triangle_collision(triangle, point):
